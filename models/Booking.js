...
function invoiceSetter(v) {
  const s =
    typeof normalizeInvoiceNo === 'function'
      ? normalizeInvoiceNo(v)
      : v;
...
const BookingSchema = new Schema(
  {
    ...
    /* Referenzen */
    customerId: { type: Types.ObjectId, ref: 'Customer', index: true }, // zugeordnetes Elternprofil
    childId: { type: Types.ObjectId, ref: 'Child', index: true }, // konkretes Kind (Child-Model)
    ...
    /* 🔹 NEU: freie Zusatzinfos (Rabatte, Base-Price, etc.) */
    meta: {

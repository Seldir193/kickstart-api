...
const { requireOwner, requireId } = require("./customers/helpers/require");
const { isCancelAllowed } = require("./customers/helpers/isCancelAllowed");
const { buildFilter } = require("./customers/helpers/buildFilter");

const { listCustomers } = require("./customers/handlers/listCustomers");
const { createCustomer } = require("./customers/handlers/createCustomer");
const { getCustomer } = require("./customers/handlers/getCustomer");
const { updateCustomer } = require("./customers/handlers/updateCustomer");
...
const {
  cancellationPdf,
} = require("./customers/handlers/documents/cancellationPdf");
const { stornoPdf } = require("./customers/handlers/documents/stornoPdf");

const {
  sendStornoEmailHandler,
} = require("./customers/handlers/email/sendStornoEmail");
const {
  sendConfirmationEmailHandler,
} = require("./customers/handlers/email/sendConfirmationEmail");

const { stornoMark } = require("./customers/handlers/stornoMark");
const {
  cancelCustomerBooking,
} = require("./customers/handlers/cancelCustomerBooking");

const {
  listCustomerDocuments,
} = require("./customers/handlers/documents/listCustomerDocuments");
const {
  exportCustomerDocumentsCsv,
} = require("./customers/handlers/documents/exportCustomerDocumentsCsv");
const {
  exportCustomerDocumentsZip,
} = require("./customers/handlers/documents/exportCustomerDocumentsZip");

const { patchNewsletter } = require("./customers/handlers/patchNewsletter");
const { addChild } = require("./customers/handlers/addChild");
const {
  createFamilyMember,
} = require("./customers/handlers/createFamilyMember");
const { getFamily } = require("./customers/handlers/getFamily");

const {
  addAdminBooking,
} = require("./customers/handlers/bookings/addAdminBooking");
...
router.get("/", (req, res) =>
  listCustomers(req, res, requireOwner, buildFilter),
);
router.post("/", (req, res) => createCustomer(req, res, requireOwner));
...
router.get("/:id", (req, res) =>
  getCustomer(req, res, requireOwner, requireId),
);
...
router.put("/:id", (req, res) =>
  updateCustomer(req, res, requireOwner, requireId),
);
...
router.delete("/:id", (req, res) =>
  deleteCustomer(req, res, requireOwner, requireId),
);

/* ===================================================================== */
/* ====================== CUSTOMER-WIDE CANCELLATION =================== */
/* ===================================================================== */
...
router.get("/:id/documents", (req, res) =>
  listCustomerDocuments(req, res, requireOwner, requireId),
);

router.get("/:id/documents.csv", (req, res) =>
  exportCustomerDocumentsCsv(
    req,
    res,
    requireOwner,
...
router.get("/:id/documents.zip", (req, res) =>
  exportCustomerDocumentsZip(
    req,
    res,
    requireOwner,
...
/* ===================================================================== */
/* ======================= BOOKING DOCUMENT ROUTES ===================== */
/* ===================================================================== */

router.post("/:id/bookings/:bid/documents/participation", (req, res) =>
  participationPdf(req, res, requireOwner, requireId, buildParticipationPdf),
);

router.post("/:id/bookings/:bid/documents/storno", (req, res) =>
  stornoPdf(
    req,
    res,
    requireOwner,
...
router.post("/:id/bookings/:bid/documents/cancellation", (req, res) =>
  cancellationPdf(
    req,
    res,
    requireOwner,
...
router.post("/:id/bookings/:bid/email/confirmation", (req, res) =>
  sendConfirmationEmailHandler(
    req,
    res,
    requireOwner,
...
router.post("/:id/bookings/:bid/email/storno", (req, res) =>
  sendStornoEmailHandler(
    req,
    res,
    requireOwner,
...
/* ===================================================================== */
/* ======================== BOOKING ACTIONS (STORNO/CANCEL) ============ */
/* ===================================================================== */

router.post("/:id/bookings/:bid/storno", (req, res) =>
  stornoMark(req, res, requireOwner, requireId, formatStornoNo),
);

router.post("/:id/bookings/:bid/cancel", (req, res) =>
  cancelCustomerBooking(
    req,
    res,
    requireOwner,
...
router.patch("/:id/newsletter", (req, res) => patchNewsletter(req, res));

/* ===================================================================== */
/* ============================ FAMILY / CHILDREN ====================== */
/* ===================================================================== */

router.get("/:id/family", (req, res) => getFamily(req, res));
router.post("/:id/children", (req, res) =>
  addChild(req, res, requireOwner, requireId, hasSameChild),
);
router.post("/:id/family-members", (req, res) =>
  createFamilyMember(req, res, requireOwner, requireId),
);
...
router.post("/:id/bookings", (req, res) =>
  addAdminBooking(req, res, requireOwner, requireId),
);
...
// router.patch("/:id/newsletter", (req, res) =>
//   patchNewsletter(req, res, syncCustomerNewsletter),
// );
...
//       cat === "holiday" ||
//       cat === "holidayprograms" ||
//       /camp|feriencamp|holiday|powertraining|power training/i.test(
//         `${type} ${sub}`,
//       );
...
//               19,
//               Math.floor(
//                 (Date.now() - new Date(customer.child.birthDate).getTime()) /
...
//       (refInvoiceNo && String(refInvoiceNo).trim()) ||
...
//         message:
//           "Für diese Stornorechnung fehlt die Referenz auf die Originalrechnung. Bitte zuerst die Teilnahme/Rechnung senden oder refInvoiceNo/refInvoiceDate mitgeben.",
//       });
//     }
...
//       return res
//         .status(500)
//         .json({ error: "PDF_BUILD_FAILED", detail: String(e?.message || e) });
//     }
...
//       return res
//         .status(502)
//         .json({ error: "MAIL_SEND_FAILED", detail: String(e?.message || e) });
//     }
...
//       const b =
//         (customer.bookings || []).find((x) => String(x._id) === d.bookingId) ||
//         {};
...
//         ? ""
//         : normalizeInvoiceNo(
//             b.refInvoiceNo || b.invoiceNumber || b.invoiceNo || "",
//           );
//       const refDate = isPart ? null : b.refInvoiceDate || b.invoiceDate || null;

//       const cancellationNo = isCanc
//         ? b.cancellationNo || b.cancellationNumber || ""
//         : "";

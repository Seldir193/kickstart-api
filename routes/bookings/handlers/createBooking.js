...
//   if (isCamp) {
//     memberDiscount = (await hasWeekly({
//       offer,
//       first,
//       last,
//       birthDateRaw,
...
//     siblingDiscount,
//     memberDiscount,
//     totalDiscount: siblingDiscount + memberDiscount,
//   };
// }
...
//   siblingGoalkeeperSurcharge,
//   goalkeeperTotal,
//   voucherCode: safeText(meta?.voucher || body?.voucher),
//   voucherDiscount,
//   totalDiscount,
// };
// }
...
//   const voucherDiscount = voucherDiscountFromBody(body, meta);
...
async function createBookingCore({ body, providerId }) {
  ...
  //     ? Math.max(0, basePrice - discounts.totalDiscount)
  //     : basePrice;
...
// const { childHasActiveWeeklyBooking } = require("../../../utils/relations");
// const { sendBookingAckEmail } = require("../../../utils/mailer");
...
// // function isTrainingCampKey(text) {
// //   return /training[\s_-]*camp|training[\s_-]*camps|trainingcamp|trainingcamps|trainingscamp|trainingscamps/.test(
// //     text,
// //   );
// // }
...
//     venue: offer.location || "",
//     message: body?.message ? String(body.message) : "",
//     status: bookingStatus({ isHoliday, isCamp, isPower }),
//     adminNote: body?.adminNote || "",
//     ...prices,
//     invoiceTo: buildInvoiceToFromBody(body),
//     meta: { ...meta },
...
// async function sendAckSafe({ created, offer, pro, isNonTrial, isHoliday }) {
//   if (isHoliday) return;
...
// async function createBookingCore({ body, providerId }) {
//   console.log("DEBUG createBookingCore entered");

//   const ctx = await buildCreateContext(body, providerId);
//   const invoiceTo = buildInvoiceToFromBody(body);

//   console.log("DEBUG offer", ctx.offer);
//   console.log("DEBUG isClub", ctx.isClub);
//   console.log("DEBUG first/last/email", {
//     first: ctx.first,
//     last: ctx.last,
//     email: safeEmail(body.email),
//     parentEmail: safeEmail(invoiceTo?.parent?.email || body.email),
//   });
//   console.log(
//     "DEBUG clubProgramCourseKey",
//     clubProgramCourseKey(ctx.offer, {
//       offerType: ctx.offer?.type,
//       offerTitle: ctx.offer?.title,
//     }),
//   );
...
//   if (ctx.isClub) {
//     console.log(
//       "DEBUG club duplicate check start",
//       clubDuplicateLogPayload(ctx, customerEmail),
//     );
//   }
...
//   if (ctx.isClub) {
//     console.log("DEBUG club duplicate result", {
//       ...clubDuplicateLogPayload(ctx, customerEmail),
//       found: !!existing,
...
//   // if (ctx.isClub && existing) {
//   //   console.log("DEBUG hard stop club duplicate", {
...
// async function createBooking(req, res) {
//   console.log("DEBUG createBooking route hit", {

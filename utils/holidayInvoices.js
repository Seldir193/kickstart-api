...
//       p.parentFirstName,
//     ),
//     lastName: pickFirst(billing.lastName, billing.last_name, p.parentLastName),
//     email: pickFirst(billing.email, p.parentEmail, p.email),
//     phone: pickFirst(billing.phone, billing.phone_number, p.phone),
//     street: pickFirst(addr.street, addr.address_1, p.street, p.address1),
//     houseNo: pickFirst(
//       addr.houseNo,
//       addr.house_no,
...
//   const billing = mapWpBilling(payload);
//   if (!booking.invoiceTo) booking.invoiceTo = {};
//   booking.invoiceTo.parent = {
//     salutation: billing.salutation || "",
//     firstName: billing.firstName || "",
...
//   // console.log("[holidayInvoice] payload keys:", Object.keys(payload || {}));
//   // console.log("[holidayInvoice] billing mapped:", billing);
//   // console.log("[holidayInvoice] customer before:", {
//   //   parent: customer?.parent,
//   //   address: customer?.address,
//   // });
...
//       : typeof ref?.priceAtBooking === "number"
//         ? Number(ref.priceAtBooking)
//         : alreadyInvoiced
//           ? null
//           : typeof offer?.price === "number"
//             ? Number(offer.price)
...
//       //neu unten monthlyAmount: amount != null ? amount : null,
//       firstMonthAmount: null,
//       venue: booking.venue || offer?.location || "",
//     });
//   } catch (e) {
